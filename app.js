...
function showQuizResult() {
  ...
  // Update resume preview MBTI badge
...
function renderMatchedVacancies(type) {
  ...
  // Build vacancy cards with fake match %
  const t = T[lang];
...
const AI_RESPONSES = [
  ...
  'Удали лишние слова: "ответственный", "коммуникабельный" — они не несут смысла. Замени конкретными фактами.',
